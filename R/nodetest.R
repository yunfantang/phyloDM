#' PhyloDM Triplet Statistic for Cross-group Testing of Mean Proportions
#'
#' \code{nodetest} returns phyloDM node and triplet test statistics based on Method-
#' of-Moments (MoM) asymptotic test on each internal node.
#' 
...
#' \item{\code{MoMp}}{Method-of-Moments (MoM) p-value for each internal node
#' using the phyloDM model.}
#' \item{\code{tripletstat}}{Triplet test statistics using the phyloDM model. Each 
...
#' @author Yunfan Tang
#' @references Tang, Y., Ma, Li. and Nicolae, D. L. (2016). Phylogenetic 
